...
function StatCard({ label, value, detail, tone = "blue", icon: Icon, notice }: { label: string; value: string; detail?: string; tone?: string; icon?: typeof TrendingUp; notice?: string }) {
  return (
