...
function LiveTransactionsCard({ onAdd, onEdit, onDelete, profileId, onManageCategories }: { onAdd: () => void; onEdit?: (item: any) => void; onDelete?: (item: any) => void; profileId?: number; onManageCategories?: () => void }) {
  const { isAuthenticated } = useAuth();
